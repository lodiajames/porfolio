         ...
         <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
            {isAboveMediumScreens ? (
                 ...
                 > 
                   <img
            alt="profile"
            className="z-10 w-full max-w-[300px] md:max-w-[500px] rounded-full hover:filter hover:saturate-150"
            src="/assets/profile-pic2.png"
          />
      
          </div>
            ) : (
                <img className="hover:filter hover:saturate-200 transition duration-500 z-10 w-full rounded-full
                max-w-[300px] md:max-w-[400px}"
                 alt="profile" src='./assets/profile-pic2.png'/>
            )}
            </div>
            {/* main section */}
              <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                variants={{
                   ...
                   <p className="mt-10 mb-7 text-xl text-center md:text-start flex  gap-3">
                    {/* I'm a software developer, data analyst  */}
                                        
                       <span class='ml-20  md:ml-10'>I'm a </span> <Typewriter className="text-center  items-center"
                        options={{
                            strings: ['Software developer', 'Data Analyst', 'UX/UI Designer'],
                            autoStart: true,
                            loop: true,
                        }}
                        />
